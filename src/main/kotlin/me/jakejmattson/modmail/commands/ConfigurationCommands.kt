...
fun configurationCommands(configuration: Configuration) = commands("Configuration") {
    ...
    guildCommand("SetReportCategory") {
        ...
        execute(CategoryArg) {
            ...
            configuration[reportCategory.guild.id.value]!!.reportCategory = reportCategory.id.value
            configuration.save()
            reactSuccess()
        }
    }
    ...
    guildCommand("SetArchiveChannel") {
        ...
        execute(ChannelArg) {
            ...
            configuration[archiveChannel.guild.id.value]!!.archiveChannel = archiveChannel.id.value
            configuration.save()
            reactSuccess()
        }
    }
    ...
    guildCommand("SetStaffRole") {
        ...
        execute(RoleArg) {
            ...
            configuration[message.getGuild().id.value]!!.staffRoleId = staffRole.id.value
            configuration.save()
            reactSuccess()
        }
    }
    ...
    guildCommand("SetLoggingChannel") {
        ...
        execute(ChannelArg) {
            ...
            configuration[loggingChannel.guild.id.value]!!.loggingConfiguration.loggingChannel = loggingChannel.id.value
            configuration.save()
            reactSuccess()
        }
    }
